...
"actions":
  ...
  - "desc": "The cultist casts one of the following spells, using Charisma as the\
      ...
      \n**1/day each:** [Jallarzi's Storm of Radiance](3.%20Mechanics/CLI/spells/jallarzis-storm-of-radiance-xphb.md)\
      \ (level 7 version), [Mass Suggestion](3.%20Mechanics/CLI/spells/mass-suggestion-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "3.%20Mechanics/CLI/bestiary/humanoid/token/cultist-hierophant-xmm.webp"
```
^statblock
