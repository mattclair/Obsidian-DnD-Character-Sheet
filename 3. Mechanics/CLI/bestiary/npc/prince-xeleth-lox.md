...
"cr": "8"
"traits":
  - "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](3.%20Mechanics/CLI/rules/conditions.md#Charmed)\
      \ condition on itself, and magic can't put it to sleep."
    "name": "Fey Ancestry"
  - "desc": "Xeleth wears a suit of [elven chain](3.%20Mechanics/CLI/items/elven-chain-xdmg.md)."
...
"source":
  - "LoX"
"image": "3.%20Mechanics/CLI/bestiary/npc/token/prince-xeleth-lox.webp"
```
^statblock