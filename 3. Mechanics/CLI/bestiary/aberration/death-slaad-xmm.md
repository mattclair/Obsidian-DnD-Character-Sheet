...
"actions":
  ...
  - "desc": "The slaad casts one of the following spells, requiring no Material components\
      ...
      \ Image](3.%20Mechanics/CLI/spells/major-image-xphb.md)\n\n**1/day each:** [Blight](3.%20Mechanics/CLI/spells/blight-xphb.md)\
      \ (level 8 version), [Cloudkill](3.%20Mechanics/CLI/spells/cloudkill-xphb.md)\
      \ (level 6 version), [Fly](3.%20Mechanics/CLI/spells/fly-xphb.md), [Plane Shift](3.%20Mechanics/CLI/spells/plane-shift-xphb.md),\
...
"source":
  - "XMM"
"image": "3.%20Mechanics/CLI/bestiary/aberration/token/death-slaad-xmm.webp"
```
^statblock
