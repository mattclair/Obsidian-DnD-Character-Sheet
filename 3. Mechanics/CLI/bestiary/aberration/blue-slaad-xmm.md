...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing\
      ...
      \ [Hit Points](3.%20Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), and\
      ...
      \ normal after finishing a [Long Rest](3.%20Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).\
      \ If the curse reduces the target's [Hit Point](3.%20Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      \ maximum to 0, the curse ends, and instead of dying, the target instantly transforms\
      \ into a [Red Slaad](3.%20Mechanics/CLI/bestiary/aberration/red-slaad-xmm.md)\
      \ or, if it can cast spells of level 3 or higher, a [Green Slaad](3.%20Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md).\
      \ Only a [Wish](3.%20Mechanics/CLI/spells/wish-xphb.md) spell can reverse this\
      \ transformation."
    "name": "Mutating Claw"
"source":
  - "XMM"
"image": "3.%20Mechanics/CLI/bestiary/aberration/token/blue-slaad-xmm.webp"
```
^statblock
